  ...
  angular.module('dimApp')
    ...
    .config([
      ...
      function($compileProvider) {
        ...
        // var newImgSrcSanitizationWhiteList = currentImgSrcSanitizationWhitelist.toString().slice(0, -1) + '|https?|data|local|chrome-extension:' + currentImgSrcSanitizationWhitelist.toString().slice(-1);
        //
        ...
        var currentImgSrcSanitizationWhitelist = $compileProvider.imgSrcSanitizationWhitelist();
        var newImgSrcSanitizationWhiteList = currentImgSrcSanitizationWhitelist.toString().slice(0,-1) + '|https?|chrome-extension:' + currentImgSrcSanitizationWhitelist.toString().slice(-1);
